...
- Auth: migrate legacy `auth-profiles.json` API key entries that omit type metadata (fixes #11516).
...
- Security: default browser evaluate capability to disabled unless configured. (fixes #11541)
